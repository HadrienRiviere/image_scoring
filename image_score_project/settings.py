"""
Django settings for image_score_project project.
...
SECRET_KEY = 'django-insecure-#!p@d3(u7@mh77*&el#(a$go456pqi1=-#mens+$eth8mc2q2$'
...
ROOT_URLCONF = 'image_score_project.urls'
...
WSGI_APPLICATION = 'image_score_project.wsgi.application'
